...
> **기준 시점 안내:** 아래는 9/10 활성화 시점의 계정 기준·검증 기록입니다. 이후 리뷰 연결 해제·정책과 운영 후속은 [9/17 현재 상태](current-state-2026-09-17.md), 실제 사본 만료·종료는 [후속 WBS](https://github.com/toilet-project/docs/issues/94)를 함께 확인하세요. 아래 “남은 인수”를 현재 전체 미완료 목록으로 사용하지 않습니다.
