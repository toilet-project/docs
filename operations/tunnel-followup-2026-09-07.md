...
6. 명시한 시험 자원 정리 승인 후 docs 시험 Secrets4개·서버 시험키1줄 제거, 시험 workflow/listener 비활성화 완료. Cloudflare 시험 경로4개·앱3개·전용 CI 정책/토큰은 브라우저 제어 연결이 끊겨 미삭제다. 현재 운영 Tunnel/공용 본인 허용 정책/배포 토큰/개인 키/복구 자료는 삭제 대상 아님.
