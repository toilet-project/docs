...
> **기록 시점: 2026-09-06.** 아래 버전·집계·시험 결과는 당시 값이며 현재 최신값이라는 뜻이 아닙니다. 2026-09-10 문서만 main으로 옮겼고, 이 문서화로 감시 코드·서비스·로그 보관 설정을 새로 적용하지 않았습니다. 최신 계정/보호 설정은 [현재 운영 기준](account-lifecycle-current-2026-09-10.md), 전체 인수는 [WBS 점검](wbs-audit-2026-09-10.md)을 참조하세요.
