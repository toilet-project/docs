...
> **전환 당시 기록입니다.** 현재 구조는 [아키텍처 v5](architecture-v5.md)와 [운영 상태](../operations/current-state-2026-09-17.md)를 확인하세요.

> **2026-09-10 후속 갱신:** 연결 구조는 아래 v4를 참고하고, 회원 탈퇴·복구 ON 및 국내 LOCAL 보호 흐름은 [최신 계정 아키텍처](../operations/account-lifecycle-current-2026-09-10.md)를 따른다. 아래의 당시 미완료 Tunnel 인수는 [전체 WBS 점검](../operations/wbs-audit-2026-09-10.md)에서 갱신했다.
